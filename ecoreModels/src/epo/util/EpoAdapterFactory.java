...
public class EpoAdapterFactory extends AdapterFactoryImpl {
	...
	protected EpoSwitch<Adapter> modelSwitch =
		new EpoSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCanadianAddress(CanadianAddress object) {
				return createCanadianAddressAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link epo.CanadianAddress <em>Canadian Address</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCanadianAddressAdapter() {
		return null;
	}
